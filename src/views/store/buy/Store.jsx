...
export default function StorePage() {
    ...
    if ( all_products.loading ) { return <PageLoading /> }
    else if ( all_products.error ) { return <PageError pass_error={ all_products.error } /> }
    else {
        const data_products = all_products.data;
